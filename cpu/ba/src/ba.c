...
void ecross(double const *a, double const *b, double *out) {
...
void dcompute_reproj_error(double const *cam, double *dcam, double const *X,
                           ...
                           double const *feat, double *dfeat, double *err,
                           double *derr) {
#if ALL_ACTIVE
  __enzyme_autodiff(ecompute_reproj_error, enzyme_dup, cam, dcam, enzyme_dup, X,
                    dX, enzyme_dup, w, wb, enzyme_dup, feat, dfeat,
...
void dcompute_w_error(double const *w, double *wb, double *err, double *derr) {
