...
void gmm_objective(int d, int k, int n, double const *restrict alphas,
                   double const *restrict means, double const *restrict icf,
                   double const *restrict x, Wishart const *restrict wishart,
                   double *restrict err) {
  int ix, ik;
...
void dgmm_objective(int d, int k, int n, double const *restrict alphas,
  ...
  __enzyme_autodiff(gmm_objective, d, k, n, alphas, dalphas, means, dmeans, icf,
                    dicf, enzyme_dup, x, dx, enzyme_dup, &wishart, dwishart,
                    enzyme_dupnoneed, err, derr);
#else
  // Default activity
  return __enzyme_autodiff(gmm_objective, d, k, n, alphas, dalphas, means,
                           dmeans, icf, dicf, enzyme_const, x, enzyme_const,
                           &wishart, enzyme_dupnoneed, err, derr);
#endif
}
