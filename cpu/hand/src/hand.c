...
inline void mat_mult(const Matrix *__restrict lhs, const Matrix *__restrict rhs,
...
void hand_objective(double const *__restrict theta, int bone_count,
                    ...
                    Matrix *__restrict points, double *__restrict err) {
...
void dhand_objective(double const *theta, double *dtheta, int bone_count,
                     ...
                     double *derr) {
#if ALL_ACTIVE
  // Version where everything is active
  __enzyme_autodiff(
      hand_objective, enzyme_dup, theta, dtheta, enzyme_const, bone_count,
      enzyme_const, bone_names, enzyme_const, parents, enzyme_dup,
      base_relatives, dbase_relatives, enzyme_dup, inverse_base_absolutes,
      dinverse_base_absolutes, enzyme_dup, base_positions, dbase_positions,
      enzyme_dup, weights, dweights, enzyme_const, triangles, enzyme_const,
      is_mirrored, enzyme_const, corresp_count, enzyme_const, correspondences,
      enzyme_dup, points, dpoints, enzyme_dupnoneed, err, derr);
#else
  // Version with default activity analysis
  __enzyme_autodiff(
      hand_objective, enzyme_dup, theta, dtheta, enzyme_const, bone_count,
