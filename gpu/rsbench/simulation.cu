...
__global__ void xs_lookup_kernel_baseline(Input in, SimulationData GSD )
{
	...
	d_macro_xs[0] = 1.0;
	double *d_pseudo_k0rs = (double *)malloc(GSD.length_pseudo_K0RS * sizeof(double));
	Window *d_windows = (Window *)malloc(GSD.length_n_windows * sizeof(Window));
	...
	__enzyme_autodiff((void*)calculate_macro_xs,
				...
				enzyme_const, mat,
				enzyme_const, E, // !! double
				enzyme_const, in, 
				enzyme_const, GSD.num_nucs, // array of ints
				enzyme_const, GSD.mats, // array of ints
				enzyme_const, GSD.max_num_nucs, 
				enzyme_const, GSD.concs, // !! double
				enzyme_const, GSD.n_windows, // array of ints
				enzyme_dup, GSD.pseudo_K0RS, d_pseudo_k0rs, // !!!! array of doubles
				enzyme_const, GSD.windows,  // !!!! array of structs that contain doubles
	...
	__enzyme_autodiff((void*)calculate_macro_xs,
				...
				enzyme_const, GSD.concs, // !! double
				enzyme_const, GSD.n_windows, // array of ints
				enzyme_const, GSD.pseudo_K0RS, // !!!! array of doubles
				enzyme_const, GSD.windows, // !!!! array of structs that contain doubles
				//enzyme_const,   GSD.poles,
				enzyme_dup,   GSD.poles, GSD.d_poles,
				enzyme_const, GSD.max_num_windows, 
