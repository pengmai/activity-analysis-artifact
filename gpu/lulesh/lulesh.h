...
public: 
  ...
  // additional terms
  Vector_d<Real_t> d_p ;          /* pressure */
  Vector_d<Real_t> d_q ;          /* q */
  Vector_d<Real_t> d_ql ;         /* linear term for q */
  Vector_d<Real_t> d_qq ;         /* quadratic term for q */
  Vector_d<Real_t> d_v ;          /* relative volume */
